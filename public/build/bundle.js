...
var app = (function () {
    ...
    // (44:2) <Card     imageSrc="assets/counterpoint_animation.gif"     imageAlt="A GIF of Counterpoint used to animate between two scatter plot layouts containing 10,000 points."     url="https://dig.cmu.edu/counterpoint/"   >
    function create_default_slot_5$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a2.textContent = "NPM";
    			attr_dev(span, "class", "fw3 ml1");
    			add_location(span, file$4, 49, 20, 1720);
    			attr_dev(h3, "class", "mb0 lh-title");
    			add_location(h3, file$4, 48, 4, 1674);
    			attr_dev(p0, "class", "lh-copy");
    			add_location(p0, file$4, 53, 4, 1813);
    			attr_dev(a0, "class", "f6 link dim ph3 pv2 dib white bg-blue");
    			attr_dev(a0, "href", "https://dig.cmu.edu/counterpoint/");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$4, 59, 6, 2024);
    			attr_dev(a1, "class", "f6 link dim ph3 pv2 dib white bg-black");
    			attr_dev(a1, "href", "https://github.com/cmudig/counterpoint");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$4, 64, 6, 2185);
    			attr_dev(a2, "class", "f6 link dim ph3 pv2 dib white bg-black");
    			attr_dev(a2, "href", "https://www.npmjs.com/package/counterpoint-vis");
    			attr_dev(a2, "target", "_blank");
    			add_location(a2, file$4, 69, 6, 2345);
    			add_location(p1, file$4, 58, 4, 2014);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    			append_dev(h3, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(44:2) <Card     imageSrc=\\\"assets/counterpoint_animation.gif\\\"     imageAlt=\\\"A GIF of Counterpoint used to animate between two scatter plot layouts containing 10,000 points.\\\"     url=\\\"https://dig.cmu.edu/counterpoint/\\\"   >",
    		ctx
    	});
    ...
    // (77:2) <Card     imageSrc="assets/divisi.png"     imageAlt="Screenshot of Divisi showing slices for a model trained on the UCI Adult dataset."     url="https://github.com/cmudig/divisi-toolkit"   >
    function create_default_slot_4$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a1.textContent = "Preprint";
    			attr_dev(span, "class", "fw3 ml1");
    			add_location(span, file$4, 82, 14, 2760);
    			attr_dev(h3, "class", "mb0 lh-title");
    			add_location(h3, file$4, 81, 4, 2720);
    			attr_dev(p0, "class", "lh-copy");
    			add_location(p0, file$4, 84, 4, 2831);
    			attr_dev(a0, "class", "f6 link dim ph3 pv2 dib white bg-black");
    			attr_dev(a0, "href", "https://github.com/cmudig/divisi-toolkit");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$4, 90, 6, 3075);
    			attr_dev(a1, "class", "f6 link dim ph3 pv2 dib white bg-black");
    			attr_dev(a1, "href", "https://arxiv.org/abs/2502.10537");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$4, 95, 6, 3237);
    			add_location(p1, file$4, 89, 4, 3065);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    			append_dev(h3, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(77:2) <Card     imageSrc=\\\"assets/divisi.png\\\"     imageAlt=\\\"Screenshot of Divisi showing slices for a model trained on the UCI Adult dataset.\\\"     url=\\\"https://github.com/cmudig/divisi-toolkit\\\"   >",
    		ctx
    	});
    ...
    // (103:2) <Card     imageSrc="assets/emblaze.png"     imageAlt="Two screenshots of the Emblaze user interface."     url="https://github.com/cmudig/emblaze"   >
    function create_default_slot_3$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a1.textContent = "GitHub";
    			attr_dev(span, "class", "fw3 ml1");
    			add_location(span, file$4, 108, 15, 3603);
    			attr_dev(h3, "class", "mb0 lh-title");
    			add_location(h3, file$4, 107, 4, 3562);
    			attr_dev(p0, "class", "lh-copy");
    			add_location(p0, file$4, 112, 4, 3702);
    			attr_dev(a0, "class", "f6 link dim ph3 pv2 dib white bg-blue");
    			attr_dev(a0, "href", "https://drive.google.com/file/d/1h7N73O4Q-d_9l9H5TT0V8VLqtlpWKsM7/view?usp=share_link");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$4, 117, 6, 3889);
    			attr_dev(a1, "class", "f6 link dim ph3 pv2 dib white bg-black");
    			attr_dev(a1, "href", "https://github.com/cmudig/emblaze");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$4, 122, 6, 4094);
    			add_location(p1, file$4, 116, 4, 3879);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    			append_dev(h3, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(103:2) <Card     imageSrc=\\\"assets/emblaze.png\\\"     imageAlt=\\\"Two screenshots of the Emblaze user interface.\\\"     url=\\\"https://github.com/cmudig/emblaze\\\"   >",
    		ctx
    	});
    ...
    // (130:2) <Card     imageSrc="assets/textessence.png"     imageAlt="Screenshot of TextEssence that shows a scatter plot of COVID concepts"     url="https://textessence.dbmi.pitt.edu"   >
    function create_default_slot_2$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "fw3 ml1");
    			add_location(span, file$4, 135, 19, 4490);
    			attr_dev(h3, "class", "mb0 lh-title");
    			add_location(h3, file$4, 134, 4, 4445);
    			attr_dev(p0, "class", "lh-copy");
    			add_location(p0, file$4, 139, 4, 4587);
    			attr_dev(a0, "class", "f6 link dim ph3 pv2 dib white bg-blue");
    			attr_dev(a0, "href", "https://textessence.dbmi.pitt.edu");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$4, 145, 6, 4854);
    			attr_dev(a1, "class", "f6 link dim ph3 pv2 dib white bg-black");
    			attr_dev(a1, "href", "https://github.com/drgriffis/text-essence");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$4, 150, 6, 5006);
    			attr_dev(a2, "class", "f6 link dim ph3 pv2 dib white bg-black");
    			attr_dev(a2, "href", "https://aclanthology.org/2021.naacl-demos.13/");
    			attr_dev(a2, "target", "_blank");
    			add_location(a2, file$4, 155, 6, 5169);
    			add_location(p1, file$4, 144, 4, 4844);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    			append_dev(h3, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(130:2) <Card     imageSrc=\\\"assets/textessence.png\\\"     imageAlt=\\\"Screenshot of TextEssence that shows a scatter plot of COVID concepts\\\"     url=\\\"https://textessence.dbmi.pitt.edu\\\"   >",
    		ctx
    	});
    ...
    // (163:2) <Card     imageSrc="assets/fireroad.png"     imageAlt="Two smartphones showing screenshots of FireRoad"     url="https://fireroad.mit.edu"   >
    function create_default_slot_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a1.textContent = "GitHub";
    			attr_dev(span, "class", "fw3 ml1");
    			add_location(span, file$4, 168, 16, 5539);
    			attr_dev(h3, "class", "mb0 lh-title");
    			add_location(h3, file$4, 167, 4, 5497);
    			attr_dev(p0, "class", "lh-copy");
    			add_location(p0, file$4, 170, 4, 5601);
    			attr_dev(a0, "class", "f6 link dim ph3 pv2 dib white bg-blue");
    			attr_dev(a0, "href", "https://fireroad.mit.edu");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$4, 176, 6, 5882);
    			attr_dev(a1, "class", "f6 link dim ph3 pv2 dib white bg-black");
    			attr_dev(a1, "href", "https://github.com/venkatesh-sivaraman/fireroad-server");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$4, 181, 6, 6028);
    			add_location(p1, file$4, 175, 4, 5872);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    			append_dev(h3, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(163:2) <Card     imageSrc=\\\"assets/fireroad.png\\\"     imageAlt=\\\"Two smartphones showing screenshots of FireRoad\\\"     url=\\\"https://fireroad.mit.edu\\\"   >",
    		ctx
    	});
    ...
    // (189:2) <Card     imageSrc="assets/shapesynth.png"     imageAlt="Two screenshots of ShapeSynth showing colored shapes in each corner"     url="https://github.com/mdhuggins/shapesynth"   >
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "fw3 ml1");
    			add_location(span, file$4, 194, 18, 6447);
    			attr_dev(h3, "class", "mb0 lh-title");
    			add_location(h3, file$4, 193, 4, 6403);
    			attr_dev(p0, "class", "lh-copy");
    			add_location(p0, file$4, 196, 4, 6518);
    			attr_dev(a, "class", "f6 link dim ph3 pv2 dib white bg-black");
    			attr_dev(a, "href", "https://github.com/mdhuggins/shapesynth");
    			attr_dev(a, "target", "_blank");
    			add_location(a, file$4, 203, 6, 6808);
    			add_location(p1, file$4, 202, 4, 6798);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    			append_dev(h3, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(189:2) <Card     imageSrc=\\\"assets/shapesynth.png\\\"     imageAlt=\\\"Two screenshots of ShapeSynth showing colored shapes in each corner\\\"     url=\\\"https://github.com/mdhuggins/shapesynth\\\"   >",
    		ctx
    	});
